/*
 * *
 *    Created by Seino Developer on 10/13/22, 2:08 PM                           *
...
package seino.indomobil.dmsmobile.domain.core.onboarding
...
fun Context.generateDataOnboarding(): List<OnboardingEntity> {
    val onBoarding = ArrayList<OnboardingEntity>()
    onBoarding.clear()
    onBoarding.add(
        OnboardingEntity(
            getString(R.string.titleonboard1),
            getString(R.string.desconboard1),
            R.drawable.img_onboardpict1
        )
    )
    onBoarding.add(
        OnboardingEntity(
            getString(R.string.titleonboard2),
            getString(R.string.desconboard2),
            R.drawable.img_onboardpict2
        )
    )
    onBoarding.add(
        OnboardingEntity(
            getString(R.string.titleonboard2),
            getString(R.string.desconboard3),
            R.drawable.img_onboardpict3
        )
    )
    return onBoarding
}