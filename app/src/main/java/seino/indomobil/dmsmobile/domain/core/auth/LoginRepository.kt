/*
 * *
 *    Created by Seino Developer on 10/13/22, 2:06 PM                           *
...
interface LoginRepository {
    suspend fun login(loginRequest: Login.LoginRequest): Flow<BaseResult<LoginEntity, ResponseWrapper<Login.LoginResponse>>>
}