/*
 * *
 *    Created by Seino Developer on 10/13/22, 1:59 PM                           *
...
package seino.indomobil.dmsmobile.data.source.auth.network
...
interface LoginService {
    ...
    @POST("auth/v1/login")
    suspend fun login(
        @Body requestLogin: Login.LoginRequest
    ): Response<ResponseWrapper<Login.LoginResponse>>
}