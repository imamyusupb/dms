/*
 * *
 *    Created by Seino Developer on 10/13/22, 2:07 PM                           *
...
class LoginUseCase @Inject constructor(
    ...
    suspend fun invoke(loginRequest: Login.LoginRequest): Flow<BaseResult<LoginEntity, ResponseWrapper<Login.LoginResponse>>> {
